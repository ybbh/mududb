...
mod tests {
    ...
    fn _test_gen_proc_desc() -> RS<()> {
        ...
        for proc in vec![
            procedure::mudu_proc_desc_add_option(),
            procedure::mudu_proc_desc_cast_vote(),
            procedure::mudu_proc_desc_create_user(),
            procedure::mudu_proc_desc_create_vote(),
            procedure::mudu_proc_desc_get_vote_result(),
            procedure::mudu_proc_desc_get_voting_history(),
            procedure::mudu_proc_desc_withdraw_vote()
        ] {
            app_proc_desc.add(proc.clone());
        }
