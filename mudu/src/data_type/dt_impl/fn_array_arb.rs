...
pub fn fn_array_arb_object(u: &mut Unstructured, dat_type: &DatType) -> arbitrary::Result<DatValue> {
    ...
    Ok(DatValue::from_array(DVIArray::new(vec)))
}

pub fn fn_array_arb_printable(u: &mut Unstructured, dat_type: &DatType) -> arbitrary::Result<String> {
